...
function SignUp({ firebase, history }) {
    ...
    function handleOrgName(newOrgName) {
        if (newOrgName === "Invalid String") {
            ...
            setmapScoutURL(
                "mapscout.io/" + newOrgName.toLowerCase().split(" ").join(""),
            );
        }
    }
                            ...
                            <Container className="container">
                                <Row>
                                    <Col xs="5" className="square">
                                        ...
                                        <p className="body-text-styles">
                                            Get started with your beautiful
                                            resource map, for free!
                                        </p>
                                        <Button
                                            className="button"
                                            size="sm"
                                    ...
                                    <Col xs="5" className="square">
                                        ...
                                        <p className="body-text-styles">
                                            Interested in using MapScout? Let's
                                            talk!
                                        </p>
                ...
                return (
                    <div>
                        <Container>
                            ...
                            <div className="body-text">
                                Enter information about your non-profit
                            </div>
                            <Form className="form-group">
                                <Form.Group controlId="formBasicEmail">
                ...
                return (
                    <div className="container">
                        ...
                        <p className="confirm-text">
                            Thank you for applying! Our team is processing your
                            organization's information and will be in touch with
                            any additional steps as soon as possible. In the
                            meanintime, your map has been created at{" "}
                            {mapScoutURL}, and you can begin to explore
                            Mapscout's features.
                        </p>
                        <Button
                            variant="primary"
    ...
    return <div id="signup">{content()}</div>;
}
